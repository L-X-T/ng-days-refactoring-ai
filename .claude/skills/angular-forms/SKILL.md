---
name: angular-forms
description: Build forms in Angular v21+ with workspace-safe form guidance. Use Reactive Forms for production work unless the user explicitly chooses experimental Signal Forms for a new form or prototype. Triggers on form implementation, validation, multi-step forms, conditional fields, or Signal Forms exploration. Don't use for third-party form libraries like Formly or ngx-formly.
---
...
Before creating or refactoring forms in this workspace, read `AGENTS.md`, `style-guide/style-guide.md`, `style-guide/style-guide.ts.md`, and `style-guide/style-guide.html.md`. Those project rules override generic examples in this skill.

This workspace prefers Reactive Forms for production code unless the user explicitly chooses experimental Signal Forms for a new Angular v21+ form or prototype. For Reactive Forms, read [references/form-patterns.md](references/form-patterns.md). For every form style, use strict types, avoid `any`, prefer `type` aliases where possible, keep template logic simple, specify button `type` attributes, avoid debug logging, and meet WCAG AA accessibility.
